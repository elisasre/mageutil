...
require (
	github.com/elisasre/go-common v1.4.21
...
require (
	...
	github.com/google/yamlfmt v0.12.1 // indirect
	...
	github.com/testcontainers/testcontainers-go/modules/compose v0.31.0 // indirect
